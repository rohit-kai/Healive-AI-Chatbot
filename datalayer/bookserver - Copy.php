...
if (isset($_POST['SubmitFeedback'])) {
    ...
    $sql = "INSERT INTO feedback (patientID, feedback) VALUES ('$patientID', '$feedback')";
    if ($mysqli->query($sql) === TRUE) {
...
if (isset($_POST['Book'])) {
    ...
    if (isset($_FILES['medical_report']) && $_FILES['medical_report']['error'] == 0) {
        ...
        $uploadFileDir = 'C:/xampp/htdocs/heallive chatbot/presentationlayer/doctor/uploads/';
        ...
        if (in_array($fileExtension, $allowedExtensions)) {
            ...
            if (move_uploaded_file($fileTmpPath, $destFilePath)) {
                ...
                $query = "INSERT INTO bookapp (Date, Time, patientID, docID, symptoms, medical_report) 
                          VALUES ('$Date', '$Time', '$_SESSION[patientID]', '$docID', '$symptoms', '$destFilePath')";
