...
<h1 class="heading" style="text-align: center;padding-bottom: 2rem;text-shadow: var(--text-shadow);text-transform: uppercase;color: var(--black);font-size: 5rem;letter-spacing: 0.4rem;margin-top: 190px;">My <span style="text-transform: uppercase;color: var(--green);">Information</span></h1>
<header>

<form method="post" action="index2.php" class="info" style="width:500px;height:300px;position:absolute;left:12%;top: 290px;background-color: var(--white);border: var(--border);">
