...
<h1 class="heading" style="text-align: center;padding-bottom: 2rem;text-shadow: var(--text-shadow);text-transform: uppercase;color: var(--black);font-size: 5rem;letter-spacing: 0.4rem;margin-top: 170px;">Search <span style="text-transform: uppercase;color: var(--black);">Donor</span></h1>
<body>
...
<form method="post" action="searchdonor.php">
	...
	<div class="input-group" style="margin-bottom: 5px;width: 100%; ">
		<label style="display: inline-block;text-align: left;position:absolute;right:790px;top:280px;font-size: 1.6rem;">Search By</label>
