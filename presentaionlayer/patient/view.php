...
<h1 class="heading" style="text-align: center;padding-bottom: 2rem;text-shadow: var(--text-shadow);text-transform: uppercase;color: var(--black);font-size: 5rem;letter-spacing: 0.4rem;margin-top: 180px;">View <span style="text-transform: uppercase;color: var(--black);">Appointment</span></h1>
