...
<a href="#" class="logo" style="margin-left: 100px;"><img src="image/logo.png" alt="" height="150px"></i></a>
    <nav class="navbar">
...
<h1 class="heading" style="text-align: center;padding-bottom: 2rem;text-shadow: var(--text-shadow);text-transform: uppercase;color: var(--black);font-size: 5rem;letter-spacing: 0.4rem;margin-top: 180px;">My <span style="text-transform: uppercase;color: var(--green);">Information</span></h1>

    <form method="post" action="index.php"  class="infoP" style="width:500px;height:300px;position:absolute;left:12%;top: 290px;background-color: var(--#D3D3D3);border: var(--border);">
    ...
    <div class="image1" style="position:absolute;right:12%;top: 250px">
