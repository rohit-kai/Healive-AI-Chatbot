...
<body>
<h1 class="heading2">View <span>Developer suggetions</span></h1>
	<table class="table4">
		<tr>
		...
		<?php $sql3="SELECT  * FROM  contact_messages " ;
		$result3=$mysqli->query($sql3);
		if(mysqli_num_rows($result3)>=1){
			while ($row3=$result3->fetch_assoc()) {

				echo "<tr><td>".$row3["id"]."</td><td>".$row3["name"]."</td><td>".$row3["email"]."</td><td>".$row3["message"]."</td><td>".$row3['submitted_at']."</td></tr>";
			}
