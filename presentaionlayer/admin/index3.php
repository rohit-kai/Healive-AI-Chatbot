...
<body>
	...
	<form method="post" action="index3.php" style="position:absolute;Left:200px;top:290px;">
	...
	<form method="post" action="index3.php" class="delete" style="position:absolute;right:200px; top:260px;">
	...
	<img src="image/Doc-Patient.gif" alt="" style="width:300px;position: absolute; top: 500px;right: 270px;">
</body>
